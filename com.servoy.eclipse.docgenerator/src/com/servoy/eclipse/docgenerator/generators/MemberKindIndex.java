...
/**
 * Holds a list with types of members, from documentation point of view.
 * Each type has an XML tag mapped to it.
 * 
 * @author gerzse
 */
public class MemberKindIndex
{
	protected final LinkedHashMap<String, String> kindsToTags = new LinkedHashMap<String, String>();

	protected MemberKindIndex()
	{
	...
	public String getWrapperTag(String kind)
	{
